...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`test_test absolute sm:top-[78px] top-[44px] z-40 sm:h-main_section_sm h-main_section bg-white transition-width duration-500 ease-in-out sm:w-[436px] w-full border-r border-gray-300 ${
